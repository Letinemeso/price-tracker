...
//	: shdr(_shdr), projection_matrix(_projection_matrix), coords(_coords), center(_center), coords_count(_coords_count)
//{
//	move_matrix =
//	{
//		1.0f, 0.0f, 0.0f, 0.0f,
...
bool object::set_texture(const char* _path) noexcept
{
